...
interface Props {
  ...
  // #331: forwarded to GroupRunCard to enable kind-aware compact rendering on the
  // per-run page. Omitted on the live `/` Schedule page, which keeps today's look.
  kind?: string
}

export default function GroupRunClient({ past, pastWorkouts, upcoming, upcomingWorkouts, isLeader, voteData, kind }: Props) {
